                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final animation = CurvedAnimation(
                      parent: controller,
                      curve: Interval(
                        (index * .015).clamp(0.0, .45),
                        ((index * .015) + .45).clamp(.45, 1.0),
                    ...
                    return AnimatedBuilder(
                      ...
                      child: Padding(
                        ...
                        child: _LevelTile(
                          ...
                          difficulty: _difficultyName(data.difficulty),
                          progress: completed
                              ? 1
                              : current
                                  ? .04
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '$completed completed • Level $current unlocked',
